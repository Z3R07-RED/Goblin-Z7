...
inspector_menu_opt=$($DIALOG --stdout --backtitle "$program_name - $current_tool_name" \
                 ...
                 1 "Images  [ Search Files  ]" $ATYPE01 "[↑↓]-Move [SPACE]-Select [ESC]-Exit" \
